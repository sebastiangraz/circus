...
function var_8d1da9bdbdad11ecadebc185310968b0(...args) {
...
function abs(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('math::abs', args, _.spec, [
    {args: [{typeId: "826011d2-bdad-11ec-abe8-2dff7f4138ed", optional: false, setoftype: false, variadic: false}], returnTypeId: "826011d2-bdad-11ec-abe8-2dff7f4138ed"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
const __defaultExports = {
  "var": var_8d1da9bdbdad11ecadebc185310968b0,
  "abs": abs,
  "ceil": ceil,
  "floor": floor,
  "ln": ln,
