...
const $anyscalar = $.makeType(_.spec, "825bcdc5-bdad-11ec-9da6-2fcf28299eec", _.syntax.literal);

const $anyreal = $.makeType(_.spec, "826011d2-bdad-11ec-abe8-2dff7f4138ed", _.syntax.literal);

const $anyfloat = $.makeType(_.spec, "8262cf8e-bdad-11ec-9d54-6f4008035d25", _.syntax.literal);

const $anyint = $.makeType(_.spec, "8260a451-bdad-11ec-937b-1dcf4b8dfe21", _.syntax.literal);

const $anynumeric = $.makeType(_.spec, "82647708-bdad-11ec-97f0-0b150d3bf3ec", _.syntax.literal);
...
const $sequence = $.makeType(_.spec, "82665f82-bdad-11ec-b373-078333dd092e", _.syntax.literal);
...
const $BaseObject = $.makeType(_.spec, "87d14843-bdad-11ec-bb88-fb6a429ece96", _.syntax.literal);

const BaseObject= _.syntax.$PathNode($.$toSet($BaseObject, $.Cardinality.Many), null, true);

const $Object_87d6bb27bdad11eca7dcbf5af1c46110 = $.makeType(_.spec, "87d6bb27-bdad-11ec-a7dc-bf5af1c46110", _.syntax.literal);

const Object_87d6bb27bdad11eca7dcbf5af1c46110= _.syntax.$PathNode($.$toSet($Object_87d6bb27bdad11eca7dcbf5af1c46110, $.Cardinality.Many), null, true);

const $FreeObject = $.makeType(_.spec, "87dd3bef-bdad-11ec-a9be-db399ee6292e", _.syntax.literal);
...
function min(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "826011d2-bdad-11ec-abe8-2dff7f4138ed", optional: false, setoftype: true, variadic: false}], returnTypeId: "826011d2-bdad-11ec-abe8-2dff7f4138ed", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "8266f132-bdad-11ec-a244-a3168a6be1c8", optional: false, setoftype: true, variadic: false}], returnTypeId: "8266f132-bdad-11ec-a244-a3168a6be1c8", returnTypemod: "OptionalType", preservesOptionality: true},
...
function sequence_reset(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "8ad5e3c4-bdad-11ec-b3b1-75fc894b2873", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "8ad5e3c4-bdad-11ec-b3b1-75fc894b2873", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
const __defaultExports = {
  ...
  "Object": Object_87d6bb27bdad11eca7dcbf5af1c46110,
